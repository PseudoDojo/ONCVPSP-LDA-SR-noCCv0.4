...
#    os.system('cd '+str(elements[ii])+'/ && sed -i \'s/4 psp8/3 both/g\' '+str(elements[ii])+'.in && sed -i \'/icmod/{n;s/.*/0 0 0/}\' '+str(elements[ii])+'.in && cd ../')
#    os.system('cd '+str(elements[ii])+'/ && sed -i \'s/4 psp8/3 both/g\' '+str(elements[ii])+'-sp.in && sed -i \'/icmod/{n;s/.*/0 0 0/}\' '+str(elements[ii])+'-sp.in && cd ../')
#    os.system('cd '+str(elements[ii])+'/ && sed -i \'s/4 psp8/3 both/g\' '+str(elements[ii])+'-spd.in && sed -i \'/icmod/{n;s/.*/0 0 0/}\' '+str(elements[ii])+'-spd.in && cd ../')
#    os.system('cd '+str(elements[ii])+'/ && sed -i \'s/4 psp8/3 both/g\' '+str(elements[ii])+'-fsp.in && sed -i \'/icmod/{n;s/.*/0 0 0/}\' '+str(elements[ii])+'-fsp.in && cd ../')
#    os.system('cd '+str(elements[ii])+'/ && sed -i \'s/4 psp8/3 both/g\' '+str(elements[ii])+'-d.in && sed -i \'/icmod/{n;s/.*/0 0 0/}\' '+str(elements[ii])+'-d.in && cd ../')
#    os.system('cd '+str(elements[ii])+'/ && sed -i \'s/4 psp8/3 both/g\' '+str(elements[ii])+'-low.in && sed -i \'/icmod/{n;s/.*/0 0 0/}\' '+str(elements[ii])+'-low.in && cd ../')
#    os.system('cd '+str(elements[ii])+'/ && sed -i \'s/4 psp8/3 both/g\' '+str(elements[ii])+'-high.in && sed -i \'/icmod/{n;s/.*/0 0 0/}\' '+str(elements[ii])+'-high.in && cd ../')
#    os.system('cd '+str(elements[ii])+'/ && sed -i \'s/4 psp8/3 both/g\' '+str(elements[ii])+'-sp-high.in && sed -i \'/icmod/{n;s/.*/0 0 0/}\' '+str(elements[ii])+'-sp-high.in && cd ../')
#    os.system('cd '+str(elements[ii])+'/ && sed -i \'s/4 psp8/3 both/g\' '+str(elements[ii])+'-spd-high.in && sed -i \'/icmod/{n;s/.*/0 0 0/}\' '+str(elements[ii])+'-spd-high.in && cd ../')
